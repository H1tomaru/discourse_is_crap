	...
	class ::MrbugController < ::ApplicationController
		...
		def feedbacks
			...
			if userfb[0]
				...
				if !userfb[0].key?(:fbG) || !userfb[0].key?(:fbB) || !userfb[0].key?(:fbN) || !userfb[0].key?(:fbBuG) || !userfb[0].key?(:fbBuB) || userfb[0][:fbG] != feedbacks[:fbG] || userfb[0][:fbB] != feedbacks[:fbB] || userfb[0][:fbBuG] != feedbacks[:fbBuG] || userfb[0][:fbBuB] != feedbacks[:fbBuB]
