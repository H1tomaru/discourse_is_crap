	...
	class ::MrbugController < ::ApplicationController
		...
		def feedbacks
			...
			if userfb[0]
				...
				if (userfb[0][:fbG] && userfb[0][:fbG] =! feedbacks[:fbG]) || (userfb[0][:fbB] && userfb[0][:fbB] =! feedbacks[:fbB]) || (userfb[0][:fbBuG] && userfb[0][:fbBuG] =! feedbacks[:fbBuG]) || (userfb[0][:fbBuB] && userfb[0][:fbBuB] =! feedbacks[:fbBuB])
